...
namespace CV.Management.Web
{
    public class FilterConfig
    {
        public static void RegisterGlobalFilters(GlobalFilterCollection filters)
        {
            ...
            filters.Add(new CspScriptSrcAttribute { Self = true, UnsafeInline = true, CustomSources = "https://az416426.vo.msecnd.net https://kit.fontawesome.com" });
            filters.Add(new CspStyleSrcAttribute { Self = true, UnsafeInline = true, CustomSources = "https://kit-free.fontawesome.com" });
            ...
            filters.Add(new CspFontSrcAttribute { Self = true, CustomSources = "https://kit-free.fontawesome.com" });

...
{
    public static class FontTablePartHelper
    {
        public static void GenerateFontTablePart1Content(FontTablePart fontTablePart1)
        {
            ...
            FontCharSet fontCharSet1 = new FontCharSet() { Val = "BA" };
            ...
            FontCharSet fontCharSet2 = new FontCharSet() { Val = "BA" };
            ...
            FontCharSet fontCharSet4 = new FontCharSet() { Val = "BA" };
            FontFamily fontFamily4 = new FontFamily() { Val = FontFamilyValues.Roman };
            Pitch pitch4 = new Pitch() { Val = FontPitchValues.Variable };
            FontSignature fontSignature4 = new FontSignature() { UnicodeSignature0 = "E00006FF", UnicodeSignature1 = "420024FF", UnicodeSignature2 = "02000000", UnicodeSignature3 = "00000000", CodePageSignature0 = "0000019F", CodePageSignature1 = "00000000" };
            ...
            FontCharSet fontCharSet5 = new FontCharSet() { Val = "BA" };
